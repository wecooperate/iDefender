...
public:
	std::shared_ptr<ILooper> GetMainLooper();
	std::shared_ptr<ILooper> GetWorkerLooper();

protected:
	std::shared_ptr<ILooper> CreateLooper(ILooper::LooperType Type, std::string_view Name);

public:
	bool IsCurrent(std::shared_ptr<ILooper> Looper);
...
private:
	...
	std::shared_ptr<ILooper> m_WorkerLooper;
};
//******************************************************************************
#endif
