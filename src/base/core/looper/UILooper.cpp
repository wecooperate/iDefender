...
HWND cxUILooper::CreateMSGWindow(void)
{
	struct stub
	{
		static LRESULT CALLBACK WindowProc(
			...
			LPARAM lParam)
		{
			cxUILooper* looper = g_Looper->Current<cxUILooper>();

			if (looper) {
				looper->OnMessage(msg, wParam, lParam);
			}
...
//******************************************************************************
cxUIMainThreadLooper::~cxUIMainThreadLooper(void)
{
	Stop();
}
//******************************************************************************
void cxUIMainThreadLooper::Start(void)
{
...
//******************************************************************************
void cxUIMainThreadLooper::Stop(void)
{
	Terminate();
